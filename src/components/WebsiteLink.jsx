...
function WebsiteLink () {
    ...
    return (
        <div className="flex w-100 h-24 items-center shrink-0
        border-2 rounded-lg back backdrop-blur-sm">

            
            <img src={PlaceholderMountain} alt="PlaceholderMountain" className=' w-23 h-auto'/>
