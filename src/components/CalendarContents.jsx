...
function CalendarContents() {
    const generateWeek = () => {
        ...
        for (let i = 0; i < 7; i++) {
          ...
          days.push(
            <div key={i} className='flex flex-col px-1 justify-center items-center gap-2'>
    ...
    return (
        <div className='size-full px-6 py-12 flex flex-col justify-between items-start'>
            <h3 className='self-stretch font-heading text-left text-2xl text-black'>No Events Today</h3>
